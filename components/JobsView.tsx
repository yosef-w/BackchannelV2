            ...
            >
              ...
              <Text
                style={[
                  ...
                  !jobUrlInput.trim() && { color: Color.muted },
                ]}
              >
                Preview Job
              </Text>
          ...
          >
            ...
            >
              {isLoadingApplicants ? (
                ...
                <View style={{ padding: 20, alignItems: "center" }}>
                  <Text
                    style={{ textAlign: "center", color: Color.muted, fontSize: 16 }}
                  >
                    No applicants yet.
                  </Text>
                </View>
          ...
          badge={
            selectedApplicantForMessage.status === "MATCHED"
              ? // Monochrome to match the "Matched" tag on the list row.
                { label: "Matched", color: Color.ink, bgColor: "#F4F4F5" }
...
const styles = StyleSheet.create({
  ...
  sponsoredCardBorder: { borderColor: Color.ink },
  sponsoredBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  cardContent: { padding: 22, paddingTop: 24 },
  ...
  tagsRow: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginBottom: 18 },
  tag: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  radioCircleActive: { borderColor: Color.ink, borderWidth: 5 },
  radioText: {
    fontFamily: Type.sans500,
    fontSize: 14,
    color: Color.body,
  ...
  confirmBtnDisabled: { backgroundColor: Color.borderStrong, shadowOpacity: 0, elevation: 0 },
  confirmBtnText: {
    fontFamily: Type.sans500,
    color: Color.paper,
    fontSize: 15,
  ...
  stepDot: { width: 8, height: 4, borderRadius: 2, backgroundColor: Color.border },
  stepDotActive: { backgroundColor: Color.ink, width: 24 },
  ...
  skillTagActive: { backgroundColor: Color.ink, borderColor: Color.ink },
  skillTagText: {
    fontFamily: Type.sans500,
    fontSize: 12,
    color: Color.body,
  ...
  skillTagTextActive: { color: Color.paper },
  backchannelCallout: {
    backgroundColor: Color.paper,
    padding: 18,
    borderRadius: Radius.lg,
  ...
  radioOuterActive: { borderColor: Color.ink },
  radioInner: {
    width: 11,
    height: 11,
    borderRadius: 6,
  ...
  // ── Applicant rows (in My Sponsored detail) ──
  applicantRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  messageModalName: { fontSize: 18, fontWeight: "800", color: Color.ink },
  messageModalRole: { fontSize: 14, color: Color.body, marginTop: 2 },
  inputLabel: {
    fontSize: 11,
    fontWeight: "900",
    color: Color.faint,
  ...
  apLoadingText: { fontSize: 13, color: Color.muted, fontWeight: "500" },
  apCapRow: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  apCapPillText: { fontSize: 11, fontWeight: "700", color: Color.body },
  ...
  apDarkChipText: { fontSize: 12, fontWeight: "700", color: Color.paper },
  apInsightItem: {
    backgroundColor: Color.paper,
    borderRadius: 14,
    borderWidth: 1,
  ...
  // ── Simple empty state (Sponsored section header) ──
  simpleEmptyState: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
