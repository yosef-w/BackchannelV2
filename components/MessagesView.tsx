...
export function MessagesView({
  ...
  const getStatusDotColor = (status: string) => {
    ...
    return (
      colors[status as keyof typeof colors] || { backgroundColor: tokens.colors.textMuted }
    );
  };
...
const styles = StyleSheet.create({
  ...
  timelineDetailLineCompleted: { backgroundColor: tokens.colors.textFaint },
